...
// Animation pour l'entrée globale de la section
...
// Animation individuelle des cartes avec un effet de rebond léger
const cardVariants = {
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight ">
             ...
             <div className="p-3 w-15 h-15 bg-brand-primary/10 rounded-2xl">
               <img src="https://img.icons8.com/?size=100&id=j8sxugcI7DaI&format=png&color=000000"  alt="icon" />
             </div>
          </div>
          <h3 className="text-center font-semibold text-xl md:2xl tracking-tight">Au fil des années et à l'issue de plusieurs projets j'ai acquis de réels compétences dans le DEV</h3>
        </motion.div>
          ...
          {SKILLS.map((skill, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                {/* Icône Icons8 avec animation de flottement */}
                <motion.div 
                  animate={{ y: [0, -5, 0] }}
                  transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
                  className="mb-6 w-16 h-16"
                >
                  <img src={skill.icon} alt={skill.category} className="w-full h-full object-contain shadow-lg rounded-xl" />
                </motion.div>

                <h3 className="font-extrabold text-xl mb-4 dark:text-white text-slate-900">{skill.category}</h3>
