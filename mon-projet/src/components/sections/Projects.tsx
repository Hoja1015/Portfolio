...
// Animation du conteneur pour l'effet de cascade
...
// Animation d'entrée pour chaque carte (Slide + Scale)
const cardVariants = {
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight ">
             ...
             <div className="p-3 w-15 h-15 bg-brand-primary/10 rounded-2xl">
               <img src="https://img.icons8.com/?size=100&id=102552&format=png&color=000000"  alt="liste de projet" />
             </div>
          </div>
        </motion.div>
        ...
        >
          {PROJECTS.map((project, index) => (
            ...
            >
              {/* Conteneur Image avec zoom et overlay */}
              <div className="relative aspect-video overflow-hidden">
                ...
                {/* Overlay au hover - style moderne flou */}
                <div className="absolute inset-0 bg-black/40 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-6">
                  <motion.a 
                    ...
                    whileTap={{ scale: 0.9 }}
                    href={project.github} 
                    className="p-4 bg-white dark:bg-slate-900 rounded-2xl shadow-lg hover:text-brand-primary transition-colors"
                  >
                    <Github size={24} />
                  </motion.a>
                  <motion.a 
